...
|---|---|---|---|---|---|
| `ai_prompt_configs` | table | [ai_prompt_configs.schema.md](ai_prompt_configs.schema.md) | [ai_prompt_configs.md](ai_prompt_configs.md) | contaminated | Configurable prompt records resolved at runtime to supply system/user templates for AI flows by profile, provider, and action. |
| `ai_runs` | table | [ai_runs.schema.md](ai_runs.schema.md) | [ai_runs.md](ai_runs.md) | contaminated | A single AI model invocation capturing the flow, provider, payloads, token usage, and progress of a generation request. |
| `ai_suggestions` | table | [ai_suggestions.schema.md](ai_suggestions.schema.md) | [ai_suggestions.md](ai_suggestions.md) | contaminated | Block-level AI suggestions produced by an AI run, scoped to a master or tailored CV and pending review/apply. |
...
| `cv_block_revisions` | table | [cv_block_revisions.schema.md](cv_block_revisions.schema.md) | [cv_block_revisions.md](cv_block_revisions.md) | contaminated | Immutable per-block revision history for a master or tailored CV, ordered per block. |
...
| `subscriptions` | table | [subscriptions.schema.md](subscriptions.schema.md) | [subscriptions.md](subscriptions.md) | contaminated | Billing subscription records linking a user to an external payment-provider plan and its lifecycle state. |
